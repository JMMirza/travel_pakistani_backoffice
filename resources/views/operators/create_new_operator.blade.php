                    ...
                    <form action="javascript:void(0);">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-label-group in-border mb-3">
                                    ...
                                    <select
                                        ...
                                        name="businessType">
                                        <option @if (old('businessType') == '') {{ 'selected' }} @endif
                                            value="">Select</option>
                                        <option @if (old('businessType') == '0') {{ 'selected' }} @endif
                                            value="0">FIT and Small GROUP Business</option>
                                        <option @if (old('businessType') == '1') {{ 'selected' }} @endif
                                            value="1">Mainly MICE Business</option>
                                        <option @if (old('businessType') == '2') {{ 'selected' }} @endif
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-label-group in-border mb-3">
                                    ...
                                    <select
                                        ...
                                        <option @if (old('typeDescription') == '') {{ 'selected' }} @endif
                                            value="">Select</option>
                                        <option @if (old('typeDescription') == '1') {{ 'selected' }} @endif
                                            value="1">Tour Operator mainly focusing on Inbound</option>
                                        <option @if (old('typeDescription') == '2') {{ 'selected' }} @endif
                            ...
                            <div class="col-md-12 col-sm-12 mb-3">
                                ...
                                <div id="snow-editor" style="height: 300px;">{!! old('about') !!}</div>
