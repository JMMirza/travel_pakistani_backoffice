...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                <form class="row g-3 needs-validation" id="projectsDetailsForm" novalidate method="POST" action="{{ route('staffs.update', $user_info->id) }}">
                    @csrf
                    @method('PATCH')
                    ...
                    <div class="col-md-6 col-sm-12">
                        <div class="form-label-group in-border">
                            ...
                            <input type="text" class="form-control" id="username" name="username" placeholder="Please enter " value="{{ isset($user_info) ? $user_info->username : old('username') }}" required>
                            <div class="invalid-tooltip">
                    ...
                    <div class="col-md-6 col-sm-12">
                        <div class="form-label-group in-border">
                            ...
                            <input type="text" class="form-control" id="phone" name="phone" placeholder="Please enter " value="{{ isset($user_info) ? $user_info->phone : old('phone') }}" required>
                            <div class="invalid-tooltip">
                                @if ($errors->has('phone'))
                                {{ $errors->first('phone') }}
                                @else
                    ...
                    <div class="col-md-6 col-sm-12">
                        <div class="form-label-group in-border mb-3">
                            ...
                            <select class="form-select form-control mb-3 @if ($errors->has('reportsTo')) is-invalid @endif" name="reportsTo">
                                <option value="" @if (old('reportsTo')=='' ) {{ 'selected' }} @endif selected disabled>
                                    Select One
                                </option>
                                @foreach ($user->userable->staff as $s)
                                <option value="{{ $s->user->id }}" @if (old('reportsTo')==$s->user->id) {{ 'selected' }} @endif>
                                    {{ $s->user->name }}
                                </option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-md-6 col-sm-12 mb-3">
                        <div class="form-label-group in-border">
                            ...
                            <input type="file" class="form-control @if ($errors->has('image')) is-invalid @endif" id="image" name="image" placeholder="Please Enter Account Name" value="{{ old('image') }}">
                            <div class="invalid-tooltip">
                                @if ($errors->has('image'))
                                {{ $errors->first('image') }}
                                @else
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form class="row g-3 needs-validation" id="projectsDetailsForm" novalidate method="POST" action="{{ route('staffs.update', $user_info->id) }}">
                    ...
                    <div class="col-md-6 col-sm-12">
                        <div class="form-label-group in-border">
                            <label for="investorPassword" class="form-label">New Password <span class="text-danger">*</span></label>
                    ...
                    <div class="col-md-6 col-sm-12">
                        <div class="form-label-group in-border">
                            ...
                            <input type="password" class="form-control @if ($errors->has('password_confirmation')) is-invalid @endif" id="password-confirm" name="password_confirmation" placeholder="Please enter " required autocomplete="new-password">
                            <div class="invalid-tooltip">
