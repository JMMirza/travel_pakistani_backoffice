<div class="tab-pane {{ $tab == 1 ? 'active' : '' }}" id="nav-border-top-01" role="tabpanel">
    <form class="row  needs-validation row g-3" action="{{ route('quotation-store') }}" method="POST" enctype='multipart/form-data' novalidate>
        @csrf
        <input type="hidden" id="quoteStatus" value="8">
        <input type="hidden" id="quotationId" value="{{ isset($quotation->id) ? $quotation->id : 0 }}">
        <div class="col-md-12">
        ...
        <div class="col-md-12">
            ...
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="markupType" id="Individual" value="Individual" checked>
                <label class="form-check-label" for="Individual">Individual Item</label>
            </div>
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="markupType" id="Total" value="Total">
