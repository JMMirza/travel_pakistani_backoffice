...
<body>
    ...
    <table style="width: 100%;">
        <tr>
            ...
            <td style="width: 100%;">
                ...
                TRAVEL PAKISTANI INVOICE



                <p style="font-size: 14px;"><strong>Venu: The Superior University (Department of Technolog) 12-L GULBERG-III LAHORE.</strong></p>
    ...
    <table class="basic">
        <tr>
            <td style="width: 22%; ">
                <p style="font-size: 14px;"><strong>Name:</strong>{{$quotation['clientName'] ?? 'N/A'}}</p>
            </td>
            <td style="width: 22%; ">
                <p style="font-size: 14px;"><strong>Contact:</strong>{{$quotation['clientContact'] ?? 'N/A'}}</p>
            </td>
            <td style="width: 22%; ">
                <p style="font-size: 14px;"><strong>E-Mail:</strong>{{$quotation['clientEmail'] ?? 'N/A'}}</p>
            </td>

        </tr>
        <tr>
            <td style="width: 22%; ">
                <p style="font-size: 14px;"><strong>Validity:</strong>{{ $quotation->validity->format('M j, Y') ?? 'N/A' }}</p>
            </td>
            <td style="width: 22%; ">
                <p style="font-size: 14px;"><strong>Adults:</strong>{{$quotation['adults'] ?? 'N/A'}}</p>
            </td>
            <td style="width: 22%; ">
                <p style="font-size: 14px;"><strong>Childern:</strong>{{$quotation['children'] ?? 'N/A'}}</p>
            </td>
        </tr>
        <tr>
            <td style="width: 22%; ">
                <p style="font-size: 14px;"><strong>City:</strong>{{ $quotation['clientContact'] ?? 'N/A' }}</p>
            </td>
            <td style="width: 22%; ">
                <p style="font-size: 14px;"><strong>Markup Type:</strong>{{ strtoupper($quotation->markupType) ?? 'N/A' }}</p>
            </td>
            <td style="width: 22%; ">
                <p style="font-size: 14px;"><strong>Preferred Dates:</strong>{{ $quotation->tourFrom->format('M j, Y') ?? 'N/A' }} to {{ $quotation->tourEnd->format('M j, Y') ?? 'N/A' }}</p>
            </td>
    ...
    <table class="basic">
        <tr>
            ...
            <th style="width: 30%">Remaining Amount</th>
        </tr>
        @foreach ($quotation->quotationInvoices as $k => $invoice)
        <tr>
            <td>{{ $k+1 }}</td>
    ...
    <table class="basic">
        <tr>
            <td style="width: 22%; ">
                <p style="font-size: 14px;"><strong>Total Amount:</strong>{{ $totalAmount ?? 'N/A' }}</p>
            </td>
            <td style="width: 22%; ">
                <p style="font-size: 14px;"><strong>Total Remaining:</strong>{{ $totalRemaining ?? 'N/A' }}</p>
            </td>
    ...
    <ul>
        <li><strong>NO MASK NO ENTRY ( FOLLOW THE SOPs of COVID 19)</strong></li>
    </ul>
    </p>
