            ...
            <div class="card">
                            ...
                            <div class="col-xxl-5 col-sm-6">
                                <div class="search-box">
                                    <input type="text" class="form-control search"
                                        placeholder="Search for customer name or something..." id="mySearch">
                            ...
                            <div class="col-xxl-2 col-sm-6">
                                <div>
                                    <input type="text" class="form-control" data-provider="flatpickr"
                                        data-date-format="d M, Y" data-range-date="true" id="created"
                ...
                <div class="card-body p-0">
                    {{-- <ul class="nav nav-tabs nav-tabs-custom nav-success" role="tablist">
                        ...
                        @foreach ($status as $s)
                            <li class="nav-item">
                                <a data-status="{{ $s->id }}" class="nav-link All py-3 status-type"
                    ...
                    <table id="quotations-response-table" class="table table-striped align-middle table-nowrap mb-0"
                        style="width:100%">
...
@push('footer_scripts')
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('#quotations-response-table').dataTable({
                searching: false,
                processing: true,
                serverSide: true,
                responsive: true,
                ...
                ajax: {
                    url: "{{ route('quotations-responses') }}",
                    data: function(d) {
                        d.status = status;
                ...
                columns: [{
                        data: 'quotation.quotationsTitle',
                        name: 'quotation.quotationsTitle',
