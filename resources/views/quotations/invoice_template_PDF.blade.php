...
<center>
    ...
    <div style="background:#fff; max-width: 960px; margin:0 auto; padding: 10px 0;">
        ...
        <table border="0" cellpadding="0" width="100%" height="100" bgcolor="#ffffff">
            ...
            <tr>
                <td colspan="2">
                    <table border="0" cellspacing="0" cellpadding="0" width="100%" style="margin-top: 0; text-align: left; border: 1px solid #666666;">
                        <thead>
                        <tr style="background: #999999; color: #fff;">
                            <th style="padding: 8px 0; border-right: 1px solid #666666; border-bottom: 1px solid #666666; text-align: center; width: 120px;">Quotation#</th>
                            <th style="padding: 8px 0; border-right: 1px solid #666666; border-bottom: 1px solid #666666; text-align: center; width: 190px;">Description</th>
                            <th style="padding: 8px 0; border-right: 1px solid #666666; border-bottom: 1px solid #666666; text-align: center; width: 60px">Staff Name</th>
                            <th style="padding: 8px 0; border-right: 1px solid #666666; border-bottom: 1px solid #666666; text-align: center; width: 80px">Total Amount</th>
                            <th style="padding: 8px 0; border-right: 1px solid #666666; border-bottom: 1px solid #666666; text-align: center; width: 100px">Due Amount</th>
                        </tr>
                        </thead>
                        <tbody>
                        ...
                        <tr>
                            ...
                            <td style="border-right: 1px solid #666666; padding: 8px 8px; text-align: left; vertical-align: top;">445675</td>
                            <td style="border-right: 1px solid #666666; padding: 8px 8px; text-align: left; vertical-align: top;">{{$quotation->quotationInvoices[0]->description ?? 'N/A'}}<br>
                            </td>
                            <td style="border-right: 1px solid #666666; padding: 8px 8px; vertical-align: top;">{{$quotation->user->name ?? 'N/A'}}</td>
                            <td style="border-right: 1px solid #666666; padding: 8px 8px; vertical-align: top;"><?php if(!empty($quotation->quotationInvoices[0]->totalAmount)) {echo  "PKR.".number_format($quotation->quotationInvoices[0]->totalAmount, 0, ".", ",");} ?></td>
                            <td style="border-right: 1px solid #666666; padding: 8px 8px; vertical-align: top;"><?php if(!empty($quotation->quotationInvoices[0]->dueAmount)) { echo  "PKR.".number_format($quotation->quotationInvoices[0]->dueAmount, 0, ".", ","); } ?></td>
                        </tr>
            ...
            <tr>
                <td colspan="2">
                    <table border="0" cellspacing="0" cellpadding="0" width="100%" style="margin-top: 0; text-align: left;">
                        <tr>
                            <td style="width: 50%; padding-top: 20px;" valign="top">
                                <textarea style="border: 1px solid #666666; width: 85%; resize: none; border-radius: 15px; padding: 15px; height: 50px;">notes will be here</textarea>
                            </td>
                            <td style="width: 40%">
                                <table border="0" cellspacing="0" cellpadding="0" width="100%" style="text-align: left;border: 1px solid #666666;">
                                    <tr>
                                        <td style="padding: 10px 15px; font-size: 24px; border-bottom: 1px solid #666666;"><b>Total </b></td>
                                        <td style="padding: 10px 15px; text-align: right; border-bottom: 1px solid #666666;"><?php if(!empty($quotation->quotationInvoices[0]->totalAmount)) { echo  "PKR.".number_format($quotation->quotationInvoices[0]->remainingAmount, 0, ".", ","); } ?></td>
                                    </tr>
                                    <tr>
                                        <td colspan="2" style="text-align: left; padding: 8px 15px;">
                                            <p>Terms: Terms will be here</p>
                                        </td>
                                    </tr>
                                </table>
                            </td>
