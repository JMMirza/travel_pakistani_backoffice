<div class="modal fade" id="quotationActivityModal" tabindex="1" aria-labelledby="quotationActivityModalLabel" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form class="needs-validation" data-target-modal="#quotationActivityModal" data-render-tbl="activity-tbl" id="hotelForm" method="POST" action="{{ route('save-quotation-activity') }}" novalidate>
                ...
                <div class="modal-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-12">
                            <label for="serviceType" class="form-label">Transfer Type <span class="text-danger">*</span></label>
                        ...
                        <div class="meal-date-section col-md-12" id="daySection" style="display:{{ isset($service) && $service->serviceDateType == 'day' ? 'block' : 'none' }} {{ isset($service) ? 'block' : 'none' }}">
                        ...
                        <div class="meal-date-section col-md-12" id="rangeSection" style="display:{{ isset($service) && $service->serviceDateType == 'range' ? 'block' : 'none' }}">
                            <div class="form-label-group in-border">
                        ...
                        <div class="meal-date-section col-md-12" id="tourSection" style="display:{{ isset($service) && $service->serviceDateType == 'tour' ? 'block' : 'none' }}"></div>
                        <div class="meal-date-section col-md-12" id="noDateSection" style="display:{{ isset($service) && $service->serviceDateType == 'nodate' ? 'block' : 'none' }}"></div>
