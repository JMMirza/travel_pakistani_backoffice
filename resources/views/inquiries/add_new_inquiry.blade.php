        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Add Inquiry</h4>
                ...
                <div class="card-body">
                    ...
                    <form class="row  needs-validation" action="{{ route('inquiries.store') }}" method="POST"
                        ...
                        <div class="col-md-4 col-sm-12 mb-3">
                            <div class="form-label-group in-border">
                                ...
                                <input type="text"
                                    ...
                                    name="contactNo" placeholder="Please Enter" value="{{ old('contactNo') }}" required>
                                <div class="invalid-tooltip">
                        ...
                        <div class="col-md-4 col-sm-12">
                            <div class="form-label-group in-border">
                                ...
                                <select name="source" id="source"
                                    ...
                                    <option @if (old('source') == '') {{ 'selected' }} @endif value=""
                                        selected>Select Source...</option>
                                    <option value="Direct Call"
                                        @if (old('source') == 'Direct Call') {{ 'selected' }} @endif>Direct Call</option>
                                    <option value="Desktop" @if (old('source') == 'Desktop') {{ 'selected' }} @endif>
                                        Desktop</option>
                                    <option value="B2C Website"
                                        @if (old('source') == 'B2C Website') {{ 'selected' }} @endif>B2C Website</option>
                                    <option value="Chat" @if (old('source') == 'Chat') {{ 'selected' }} @endif>
                                        Chat</option>
                                    <option value="Message" @if (old('source') == 'Message') {{ 'selected' }} @endif>
                                        Message</option>
                                </select>
                                <div class="invalid-tooltip">
                        ...
                        <div class="col-md-4 col-sm-12 mb-3">
                            <div class="form-label-group in-border">
                                ...
                                <input type="number"
                                    ...
                                    id="adults" name="adults" placeholder="Please Enter" value="{{ old('adults') }}"
                                    required>
                                <div class="invalid-tooltip">
                        ...
                        <div class="col-md-2 col-sm-6 mb-3">
                            ...
                            <div
                                ...
                                <input class="form-check-input" type="checkbox" role="switch" id="meal"
                                    name="meal" @if (old('meal') == 'on') {{ 'checked' }} @endif>
                            </div>
                        </div>
                        ...
                        <div class="col-md-2 col-sm-6 mb-3">
                            ...
                            <div
                                ...
                                <input class="form-check-input" type="checkbox" role="switch" id="transport"
                                    name="transport" @if (old('transport') == 'on') {{ 'checked' }} @endif>
                            </div>
                        </div>
                        ...
                        <div class="col-md-2 col-sm-6 mb-3">
                            ...
                            <div
                                ...
                                <input class="form-check-input" type="checkbox" role="switch" id="activities"
                                    name="activities" @if (old('activities') == 'on') {{ 'checked' }} @endif>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 col-sm-12">
                            <div class="form-label-group in-border">
                                ...
                                <select
                                    ...
                                    <option value="" @if (old('processedByName') == '') {{ 'selected' }} @endif
                                        selected disabled>
                                        Select One
                                    </option>
                                    @foreach ($users as $user)
                                        <option value="{{ $user->id }}"
                                            @if (old('processedByName') == $user->id) {{ 'selected' }} @endif>
                                            {{ $user->name }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-6 col-sm-12 mb-3">
                            <div class="form-label-group in-border">
                                ...
                                <textarea class="form-control @if ($errors->has('specialRequest')) is-invalid @endif" name="specialRequest"
                                    id="specialRequest" cols="30" rows="10"></textarea>
                        ...
                        <div class="col-md-6 col-sm-12 mb-3">
                            <div class="form-label-group in-border">
                                ...
                                <textarea class="form-control @if ($errors->has('staffRemarks')) is-invalid @endif" name="staffRemarks"
                                    id="staffRemarks" cols="30" rows="10"></textarea>
