            ...
            <div class="d-flex">
                ...
                <div class="navbar-brand-box horizontal-logo">
                    <a href="index.html" class="logo logo-dark">
                        <span class="logo-sm">
                            <img src="{{ asset('theme/dist/default/assets/images/logo-sm.png') }}" alt=""
                                height="22">
                        </span>
                        <span class="logo-lg">
                            <img src="{{ asset('theme/dist/default/assets/images/logo-dark.png') }}" alt=""
                                height="17">
                        </span>
                    </a>
                    ...
                    <a href="index.html" class="logo logo-light">
                        ...
                        <span class="logo-lg">
                            <img src="{{ asset('theme/dist/default/assets/images/logo-light.png') }}" alt=""
                                height="17">
                        </span>
                    </a>
                </div>
