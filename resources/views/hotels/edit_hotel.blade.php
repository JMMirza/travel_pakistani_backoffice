    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header align-items-center d-flex">
                <h4 class="card-title mb-0 flex-grow-1">Update Hotel</h4>
            </div>

            <div class="card-body">
                <form class="row  needs-validation" action="{{ route('hotels.update', $hotel->id) }}" method="POST"
                    ...
                    <div class="col-md-4 col-sm-12 mb-3">
                        <div class="form-label-group in-border">
                            ...
                            <input type="text"
                                class="form-control @if ($errors->has('hotelName')) is-invalid @endif" id="hotelName"
                                name="hotelName" placeholder="Please Enter" value="{{ $hotel->hotelName }}" required>
                    ...
                    <div class="col-md-4 col-sm-12 mb-3">
                        <div class="form-label-group in-border">
                            ...
                            <select
                                ...
                                <option value="" @if ($hotel->cityId == '') {{ 'selected' }} @endif
                                    selected disabled>
                                    Select One
                                </option>
                                @foreach ($cities as $city)
                                    <option value="{{ $city->id }}"
                                        @if ($hotel->cityId == $city->id) {{ 'selected' }} @endif>
                                        {{ $city->name }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-md-4 col-sm-12 mb-3">
                        <div class="form-label-group in-border">
                            ...
                            <input type="text"
                                ...
                                name="website" placeholder="Please Enter" value="{{ $hotel->website }}">
                            <div class="invalid-tooltip">
                    ...
                    <div class="col-md-4 col-sm-12 mb-3">
                        <div class="form-label-group in-border">
                            ...
                            <input type="text"
                                ...
                                name="email" placeholder="Please Enter" value="{{ $hotel->email }}">
                            <div class="invalid-tooltip">
                                @if ($errors->has('email'))
                                    {{ $errors->first('email') }}
                                @else
                    ...
                    <div class="col-md-4 col-sm-12 mb-3">
                        <div class="form-label-group in-border">
                            ...
                            <input type="text"
                                ...
                                name="contactNo" placeholder="Please Enter" value="{{ $hotel->contactNo }}">
                            <div class="invalid-tooltip">
                    ...
                    <div class="col-md-4 col-sm-12 mb-3">
                        <div class="form-label-group in-border">
                            ...
                            <input type="decimal" step="0.00001"
                                ...
                                name="lat" placeholder="Please enter Latitude" value="{{ $hotel->lat }}">
                            <div class="invalid-tooltip">
                                @if ($errors->has('lat'))
                                    {{ $errors->first('lat') }}
                                @else
                    ...
                    <div class="col-md-4 col-sm-12 mb-3">
                        <div class="form-label-group in-border">
                            ...
                            <input type="decimal" step="0.00001"
                                ...
                                placeholder="Please enter longitude" value="{{ $hotel->long }}">
                            <div class="invalid-tooltip">
                                @if ($errors->has('long'))
                                    {{ $errors->first('long') }}
                                @else
                    ...
                    <div class="col-md-8 col-sm-12 mb-3">
                        <div class="form-label-group in-border">
                            ...
                            <input type="text"
                                class="form-control @if ($errors->has('hotelAddress')) is-invalid @endif"
                                id="hotelAddress" name="hotelAddress" placeholder="Please Enter"
                                value="{{ $hotel->hotelAddress }}" required>
                            <div class="invalid-tooltip">
